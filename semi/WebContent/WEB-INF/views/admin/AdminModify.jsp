				...
				<div class="card shadow mb-4">
					...
					<div class="card-body mt-3">
							...
							<div class="form-group mt-3">
								...
								<textarea class="form-control mt-1" id="boardContent" name="content"
									rows="15">${board.content}</textarea>
							</div>
							<div class="form-group mt-3">
								<label for="Id">Id</label> <input class="form-control mt-1" id="Id"
									name="Id" value="${board.id}" readonly="readonly">
							</div>
							<div class="mt-3">
